...
class NativeRoverDelegate: RoverDelegate {
    
    private let uuid: String
    private let roverFlutterPlugin: RoverFlutterPlugin
    
    init(uuid: String,
         roverFlutterPlugin: RoverFlutterPlugin) {
        self.uuid = uuid
        self.roverFlutterPlugin = roverFlutterPlugin
    }
    ...
    override func roverDidFinish(sessionUUID: String,
        ...
        roverFlutterPlugin.send(uuid, argsJson) { args, error in
            self.roverFlutterPlugin.remove(delegateUUID: self.uuid)
        }
    }
